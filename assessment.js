...
assessmentButton.addEventListener(
  ...
  () => {
    ...
    paragraph.setAttribute('class','class-text');
    ...
    //headDivisionとbodyDivisionをresultDivisionに差し込む
...
const answers = [
  ...
  '###usreName###のいいところは見た目です。内側から溢れ出る###userName###の良さに皆が気を惹かれます。',
  '###userName###のいいところは決断力です。###userName###がする決断にいつも助けられる人がいます。',
  '###userName###のいいところは思いやりです。###userNamae###に気をかけてもらった多くの人が感謝しています。',
...
function test() {
  ...
  console.log('同じ名前なら同じ結果を出力することのテスト終了');
}
